Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/iZettle/sdk-ios/releases/download/#{s.version}/iZettleSDK.zip", type: :zip, :sha256 => '5c50024c933572e1abf349cd5c2d916fc96728685dd7cd364c171fcba851dae0' }
  s.source_files = []
  s.preserve_paths = '**/*'
