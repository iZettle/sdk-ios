Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/iZettle/sdk-ios/releases/download/#{s.version}/iZettleSDK.zip", type: :zip, :sha256 => 'faee5293d22ec1b7ca1be9de55fd5e843d4bf2773cf5476dbd0ba58d2a343a7f' }
  s.source_files = []
  s.preserve_paths = '**/*'
  s.public_header_files = 'iZettleSDK.xcframework/**/*.h'
